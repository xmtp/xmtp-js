import { signature, proof } from '@xmtp/proto'
...
// export default class StaticCreateIdentityProof implements proof.

export default class AssociationProof implements proof.AssociationProof {
  staticCreateIdentityProof:
    | proof.AssociationProof_StaticCreateIdentityProof
    | undefined

  siweProof: proof.AssociationProof_SIWEProof | undefined
}

export class Signature implements signature.Signature {
