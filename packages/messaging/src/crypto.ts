...
async function encrypt(plain: Uint8Array, secret: Uint8Array, additionalData?: Uint8Array):Promise<[Uint8Array,Uint8Array,Uint8Array]> {
...
async function decrypt(encrypted: Uint8Array, secret: Uint8Array, salt: Uint8Array, nonce: Uint8Array, additionalData?: Uint8Array): Promise<Uint8Array> {
    const key = await hkdf(secret, salt);
