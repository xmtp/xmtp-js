...
export const ApiUrls = {
  local: "http://localhost:5051/xmtpd",
  dev: "https://grpc.testnet-staging.xmtp.network:5558/xmtpd",
  production: "",
} as const;
...
export const PayerUrls = {
  local: "http://localhost:5051/payer",
  dev: "https://payer.testnet-staging.xmtp.network:5558/payer",
  production: "",
} as const;
