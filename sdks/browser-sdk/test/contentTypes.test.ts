...
describe("Content types", () => {
  it("should send and receive text content", async () => {
    ...
    expect(textMessage.contentType).toEqual(await textContentType());
    ...
    expect(message?.contentType).toEqual(await textContentType());
  });
  ...
  it("should send and receive markdown content", async () => {
    ...
    expect(markdownMessage.contentType).toEqual(await markdownContentType());
    expect(markdownMessage.fallback).toBeUndefined();
    const message = await client1.conversations.getMessageById(messageId);
    expect(message).toBeDefined();
    expect(message?.content).toBe("# gm");
    expect(message?.contentType).toEqual(await markdownContentType());
  });
  ...
  describe("Reaction", () => {
    it("should send and receive reaction content with added action", async () => {
      ...
      expect(decodedReaction.contentType).toEqual(await reactionContentType());
      ...
      expect(message?.contentType).toEqual(await reactionContentType());
    });
  ...
  describe("Reply", () => {
    it("should send and receive reply with text content", async () => {
      ...
      expect(replyMessage.contentType).toEqual(await replyContentType());
      ...
      expect(message).toBeDefined();
      expect(message?.contentType).toEqual(await replyContentType());
  ...
  describe("Attachment", () => {
    it("should send and receive attachment content", async () => {
      ...
      expect(message?.contentType).toEqual(await attachmentContentType());
    });
  ...
  describe("RemoteAttachment", () => {
    ...
    it("should send and receive remote attachment content", async () => {
      ...
      expect(remoteAttachmentMessage.contentType).toEqual(
        await remoteAttachmentContentType(),
      );
      ...
      expect(message?.contentType).toEqual(await remoteAttachmentContentType());
    });
  ...
  it("should send and receive multi remote attachment content", async () => {
    ...
    expect(multiRemoteAttachmentMessage.contentType).toEqual(
      await multiRemoteAttachmentContentType(),
    );
  ...
  it("should send read receipts and get last read times", async () => {
    ...
    expect(message).toBeDefined();
    expect(message?.contentType).toEqual(await readReceiptContentType());
  ...
  describe("TransactionReference", () => {
    it("should send and receive transaction reference content", async () => {
      ...
      expect(transactionReferenceMessage.contentType).toEqual(
        await transactionReferenceContentType(),
      );
  ...
  describe("WalletSendCalls", () => {
    it("should send and receive wallet send calls content", async () => {
      ...
      expect(walletSendCallsMessage.contentType).toEqual(
        await walletSendCallsContentType(),
      );
      ...
      expect(message?.contentType).toEqual(await walletSendCallsContentType());
    });
  ...
  describe("Actions", () => {
    it("should send and receive actions", async () => {
      ...
      expect(actionsMessage.contentType).toEqual(await actionsContentType());
      ...
      expect(message?.contentType).toEqual(await actionsContentType());
    });
  ...
  describe("Intent", () => {
    it("should send and receive intent", async () => {
      ...
      expect(intentMessage.contentType).toEqual(await intentContentType());
      ...
      expect(message?.contentType).toEqual(await intentContentType());
    });
  ...
  it("should send and receive group updated content", async () => {
    ...
    for (const message of messages) {
      expect(message.contentType).toEqual(await groupUpdatedContentType());
